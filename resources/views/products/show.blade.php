        ...
        <div class="product-container">
            ...
            <div class="product-images">
                ...
                <div class="thumbnail-images">
                    ...
                    <img src="https://http2.mlstatic.com/D_NQ_NP_2X_678899-MLA54395673289_032023-F.webp" alt="PS5 2" class="thumbnail" onclick="changeImage(this)">
                    <img src="https://m.media-amazon.com/images/I/51qlJiViYEL._AC_SL1500_.jpg" alt="PS5 3" class="thumbnail" onclick="changeImage(this)">
                    <img src="https://m.media-amazon.com/images/I/61SUj2aKoEL._AC_SL1500_.jpg" alt="PS5 4" class="thumbnail" onclick="changeImage(this)">
                </div>
            </div>
            ...
            <div class="product-info">
                ...
                <div class="price-section">
                    ...
                    <div class="price">
                        <span class="price-currency">$</span>499<sup>.99</sup>
                    </div>
                ...
                <div class="product-details">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value">Sony PlayStation</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Modelo:</span>
                        <span class="detail-value">CFI-1215B</span>
                    </div>
                    <div class="detail-item">
                    ...
                    <div class="detail-item">
                        <span class="detail-label">Conectividad:</span>
                        <span class="detail-value">HDMI 2.1, USB-C, WiFi 6, Bluetooth 5.1</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Dimensiones:</span>
                        <span class="detail-value">390 x 104 x 260 mm</span>
                    </div>
                    <div class="detail-item">
                        <span class="detail-label">Peso:</span>
                        <span class="detail-value">3.9 kg</span>
                    </div>
                </div>
                ...
                <div class="specifications">
                    ...
                    <table class="spec-table">
                        <tr>
                            <td>Procesador</td>
                            <td>AMD Ryzen Zen 2 de 8 núcleos a 3.5 GHz (frecuencia variable)</td>
                        </tr>
                        <tr>
                            <td>Tarjeta Gráfica</td>
                            <td>AMD Radeon RDNA 2 con 10.28 TFLOPS, 36 CUs a 2.23 GHz</td>
                        </tr>
                        <tr>
                            <td>Memoria RAM</td>
                        ...
                        <tr>
                            <td>Velocidad SSD</td>
                            <td>5.5 GB/s (Raw), 8-9 GB/s (Comprimido)</td>
                        </tr>
                        <tr>
                            <td>Resolución</td>
                            <td>Hasta 8K a 60 fps, 4K a 120 fps</td>
                        </tr>
                        <tr>
                            <td>Ray Tracing</td>
                            <td>Sí, acelerado por hardware</td>
                        </tr>
                        <tr>
                            <td>Audio</td>
                        ...
                        <tr>
                            <td>Lector de Discos</td>
                            <td>No incluido (Edición Digital)</td>
                        </tr>
                        <tr>
                            <td>Puertos</td>
                            <td>HDMI 2.1, 3x USB-A 3.1, 1x USB-C, Ethernet</td>
                        </tr>
                    </table>
                </div>
            </div>
            ...
            <div class="buy-box">
                ...
                <div class="delivery-info">
                    <strong>Envío GRATIS</strong> Llegada: Jueves, 17 Oct
                </div>
                ...
                <div style="font-size: 13px; color: #565959; line-height: 1.5;">
                    <div style="margin-bottom: 10px;">
                        <strong>Vendido por:</strong> Amazon.com
                    </div>
                    <div style="margin-bottom: 10px;">
                        <strong>Garantía:</strong> 1 año del fabricante
                    </div>
                    <div style="margin-bottom: 10px;">
