<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-radius-lg fixed-start ms-2  bg-white my-2"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link {{ Request::is('admin') ? 'active bg-gradient-dark text-white' : text-dar}} " href="{{ route('admin.index') }}">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::is('admin/category/create') ? 'active bg-gradient-dark text-white' : text-dar}}" href="{{ route('admin.category.create') }}">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        ...
        <a class="btn bg-gradient-dark w-100" href="{{ route('admin.index') }}" type="button">Contact</a>
      </div>
    </div>
  </aside>